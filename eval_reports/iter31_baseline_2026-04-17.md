...
- Documents: 16
- Avg edit distance: 0.239
- Avg char F1: 0.901
- Avg heading F1: 0.531
- Avg table cell F1: 0.485
- Total warnings: 48
- API calls (OCR/VLM/LLM): 33/51/9
- LLM fallback hits: 28
- Total wall time: 448.0s
...
| ocr01 | 0.139 | 0.960 | 0.737 | 0.903 | 0 | 4/1/1 | 4 | 37.7s |
| ocr_scan_jtg3362 | 0.234 | 0.893 | 0.095 | 0.694 | 18 | 4/6/1 | 3 | 22.6s |
| paper01 | 0.275 | 0.976 | 0.841 | 0.000 | 6 | 6/13/1 | 0 | 101.6s |
| paper_chn01 | 0.725 | 0.726 | 0.812 | 1.000 | 4 | 5/5/1 | 0 | 40.1s |
| paper_chn02 | 0.634 | 0.808 | 0.129 | 0.000 | 5 | 3/3/1 | 1 | 47.0s |
| patent01 | 0.411 | 0.904 | 0.300 | 0.974 | 2 | 2/16/1 | 9 | 119.2s |
| pdf_text01_tables | 0.041 | 0.979 | 0.000 | 0.992 | 0 | 0/0/0 | 0 | 8.4s |
| receipt | 0.068 | 0.973 | 1.000 | 0.000 | 2 | 1/2/0 | 0 | 2.2s |
| simple_doc01 | 0.709 | 0.460 | 0.312 | 0.000 | 10 | 0/0/1 | 2 | 4.3s |
| text_code_block | 0.050 | 0.975 | 0.500 | 0.000 | 0 | 0/0/0 | 0 | 0.6s |
| text_pic02 | 0.186 | 0.973 | 0.250 | 0.198 | 0 | 7/3/1 | 3 | 50.3s |
| text_report01 | 0.225 | 0.877 | 0.526 | 1.000 | 1 | 0/2/1 | 6 | 5.5s |
| text_table01 | 0.004 | 0.998 | 1.000 | 0.000 | 0 | 0/0/0 | 0 | 0.0s |
| text_table_libreoffice | 0.006 | 0.997 | 1.000 | 1.000 | 0 | 0/0/0 | 0 | 3.6s |
| text_table_word | 0.035 | 0.984 | 1.000 | 1.000 | 0 | 1/0/0 | 0 | 4.1s |
| **Average** | **0.239** | **0.901** | **0.531** | **0.485** | **48** | **33/51/9** | **28** | **448.0s** |
...
- ocr_scan_jtg3362: 18 warning(s) — Page 1: low-confidence VLM description (distance=0.76).; Page 2: orphan H2 heading without H1 parent (前言).; ...
- simple_doc01: 10 warning(s) — Page 1: heading level jump from H2 to H4 (1.3.1).; Page 1: orphan H4 heading without H3 parent (1.3.1).; ...
- paper01: 6 warning(s) — Page 3: low-confidence VLM description (distance=0.88).; Page 5: low-confidence VLM description (distance=0.79).; ...
...
- paper_chn01: 4 warning(s) — Page 1: heading level jump from H1 to H3 (Abstract).; Page 1: orphan H3 heading without H2 parent (Abstract).; ...
- patent01: 2 warning(s) — Page 2: orphan H2 heading without H1 parent (1. 一种基于静载试验识别连续梁桥实际刚度的方法，其特征在于，包括如下步骤：).; Page 3: heading level jump from H1 to H3 (（7）).
- receipt: 2 warning(s) — Page 1: heading level jump from H1 to H3 (账单与付款).; Page 1: orphan H3 heading without H2 parent (账单与付款).
- text_report01: 1 warning(s) — Rendered text volume drifted beyond tolerance: source=866 chars, output=1069 chars.
...
- Output-only excerpt: `> [图片] A faint gray line diagram with intersecting angled lines and a curved arc segment.
### 公路钢筋混凝土及预应力
### 混凝土桥涵设计规范
> [图片] 公路钢筋混凝土及预应力混凝土桥涵设计规范 JTG 3362—2018
...
> [图片] 几本不同颜色的装订册/文件夹叠放在一起，展示装订效果。
> [图片] A simple line diagram shows a booklet with stacked pages and arrows pointing to the binding edge. The label indicates stitching/binding points on the left side.`
...
- Blocks: extra=8, missing=10
- Output-only excerpt: `> [图片] A stylized blue-and-green logo with Chinese text and the word "JIAXUN" beneath it.
# 佳讯飞鸿智能科技研究院监测云裸金属服务配置指南V1
| 拟制人： | 徐蕴 | 日期： | 2022-05-30 |
| --- | --- | --- | --- |
| 审核人： | 赵文祥 | 日期： | 2022-05-30 |
| 批准人： | 张鑫 | 日期： | 2022-05-30 |
本文档是佳讯飞鸿（北京）智能科技研究院有限公司的内部文档，文档的版权属…`
- Expected-only excerpt: `|  |  |
|---|---|
...
- Output-only excerpt: `> [图片] A stylized wallet icon on a dark background.
Apply and use in minutes<sup>2</sup>
1. 3% savings is earned as Daily Cash and is the total amount of Daily Cash earned for these purchases. You can choose to direct Daily Cash to a Savings account or to an Apple Cash account. …`
